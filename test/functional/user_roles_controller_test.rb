...
class UserRolesControllerTest < ActionController::TestCase
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post :create, user_role: { description: @user_role.description, role: @user_role.role, user_id: @user_role.user_id }
    end
  ...
  test "should update user_role" do
    put :update, id: @user_role, user_role: { description: @user_role.description, role: @user_role.role, user_id: @user_role.user_id }
    assert_redirected_to user_role_path(assigns(:user_role))
  end
